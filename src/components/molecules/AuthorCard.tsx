    ...
    <Card className="p-4 shadow-lg rounded-lg">
      <Link href={`authors/${author.slug}/`}>
        <CardHeader>
          ...
          />
          <CardTitle className="text-center text-xl font-semibold">{author.name}</CardTitle>
        </CardHeader>
      </Link>
      <CardDescription className="mt-2 text-center text-gray-600">{author.bio}</CardDescription>
